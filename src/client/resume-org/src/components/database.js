      ...
      <PageBody>
        ...
        <Card className={classes.resultsCard}>
          <Grid container alignItems="center">
            <Grid item xs={8}>
              <Typography variant="h6" className={classes.resultsTypography}>Results</Typography>
            </Grid>
            <Grid item xs={4}>
            ...
            <Card className={classes.resultCard}>
              <Grid container alignItems="center">
                <Grid item xs={5}>
                  ...
                  <Typography>{result.position}, {result.experience} year{result.experience == 1 ? "" : "s"}</Typography>
                </Grid>
                <Grid item xs={4}>
                  <Typography><strong>Skills matched: </strong>{result.matchedSkills.join(", ")}</Typography>
                </Grid>
                <Grid item xs={3}>
                  <Toolbar className={classes.viewResumeContainer}>
                    <Button>View Resume<ArrowForwardIcon /></Button>
                  </Toolbar>
                </Grid>
              </Grid>
            </Card>
